/**
 * KALLAX SQLite Ticket & Task Operations
 * Factory functions for ticket and task CRUD
 */
...
import type { TicketFilter, TaskFilter, TicketRow, TaskRow } from './types.js';
import { rowToTicket, rowToTask } from './types.js';
