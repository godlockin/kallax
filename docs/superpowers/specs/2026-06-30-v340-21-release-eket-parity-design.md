...
- ⚠️ **1 release bump (v3.3.0 → v3.4.0), 累计 release 21 (跟 v2.7.5 跨 release 统计)** 跟"反讽" 联合 治根 "release 编号跳跃" 假动作
...
- **KALLAX v3.4.0 跟 eket parity 1 项** 跟"反讽" 联合 治根 KALLAX 跟 eket 不一致 假动作
...
| 2 | **eket parity 1 项 (graceful-exit.sh 跟 eket Level 4 1:1)** (跟 eket README 1:1 验证) | ✅ 跟"独立" 拍板 联合 |
...
```bash
# Step 1: 写 graceful-exit.sh (跟 eket Level 4 1:1 联合)
...
跟 v3.3.0 + eket 1:1 对齐, 跟 1 release bump (累计 release 21) 联合:

- **1 release bump (v3.3.0 → v3.4.0), 累计 release 21 (跟 v2.7.5 跨 release 统计)** 跟"反讽" 联合 治根 "release 编号跳跃"
- **eket parity 1 项 (graceful-exit.sh 跟 eket Level 4 1:1)** 跟"反讽" 联合 治根 "eket parity 100% 推进"
