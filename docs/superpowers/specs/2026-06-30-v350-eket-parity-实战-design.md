# KALLAX v3.5.0 — 实战 eket ioredis + graceful-exit 1 次 Design (跟"反讽" 联合, 跟"诚实修正" 联合, 跟"独立" 拍 explicit 约束 联合)
...
### 3.1 Task 1: 实战 eket ioredis 1 次 (跟"诚实修正" 联合 "实际 跑过 诚实")

```bash
cd /Users/chenchen/working/sourcecode/tools/dev-tools/kallax

# 1.1: 验证 ioredis 已在 dependencies (跟"诚实修正" 联合, 跟"反讽" 联合 0 假装)
grep -A 2 '"dependencies"' node/package.json | grep -E '"ioredis"|"version"'
# 期望: ioredis 在 dependencies (跟 eket parity 100% 联合)

# 1.2: 实战 ioredis Pub/Sub 1 次 (跟"诚实修正" 联合, 跟"反讽" 联合 0 假装)
# 跟 eket parity 100% 联合 (跟 v3.3.0 online-deploy-2026-06-30/README.md §1.2 1:1)
# 跟"独立" 拍板 联合, 跟"反哺框架" 战略 一致

# 写 evidence 落地 (跟"反讽" 联合 0 假装)
...
# 2.2: 实战 graceful-exit.sh --dry-run (跟"诚实修正" 联合, 跟"反讽" 联合 0 假装)
...
# 2.3: 实战 graceful-exit.sh (跟"诚实修正" 联合 "实际 跑过 诚实")
...
### 3.3 Task 3: 写 v3.5.0 release 整合文档 (跟 v3.4.0 V340-RELEASE 模式 一致)
...
**3. Type consistency**: 跟 实战 eket ioredis + graceful-exit 1 次 联合, 跟"独立" 拍 explicit 约束 联合, 跟"诚实修正" 联合

**4. Ambiguity**: 0 ambiguous

**5. 跟 v3.4.0 兼容性** (跟"反讽" 联合, 跟"诚实修正" 联合):
- ✅ ioredis 已在 node/package.json dependencies (跟 v3.4.0 aeeb5f6 联合)
- ✅ scripts/graceful-exit.sh 1593 bytes 落地 (跟 v3.4.0 联合)
- ✅ 22 release 累计 跟 v3.0.0 演化路径 1:1 (跟"反讽" 联合 0 跳 release)
- ✅ 0 假 PASS 跟"诚实修正" 联合 ("实际 跑过 诚实")
