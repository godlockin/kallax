# KALLAX v2.0.7 — 8 Gap 修复 Plan (跟"反讽" 联合, 跟"诚实修正" 联合, 跟"独立" 拍 explicit 约束 联合)

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** 修 KALLAX 跟 Karpathy 4 大核心 60% 落地率 → 80%, 推 v2.0.7. 跟"反讽" 闭环, 跟"诚实修正" 联合, 跟"独立" 拍 explicit 约束 联合, 跟"翻篇&精进" 战略 一致, 跟"流程逻辑 > 扩充配置" 战略 一致.

**Architecture:** 5 task (T1-T5), 走对策 A+B+C 落地. 跟 v2.0.6 (4 工具 multi-tool) 兼容.

**Tech Stack:** Bash + jq + Python, 0 新增依赖. 跟 Rule 9 5 levels Fact-Forcing 联合.
...
|---|---|---|
| `scripts/verify/check-assumption-clarity.sh` | Gap 1-3 从根源修复 (P0 Think Before Coding) | ✅ 跟"反讽" 联合, 跟"诚实修正" 联合 |
| `scripts/verify/check-sc-defined.sh` | Gap 4-5 从根源修复 (P1 Goal-Driven Execution) | ✅ 跟"反讽" 联合, 跟"诚实修正" 联合 |
| `docs/KALLAX-GLOSSARY.md` (modify) | Gap 6 从根源修复 (P2 Simplicity, 34 术语压缩) | ✅ 跟"反讽" 联合, 跟"翻篇&精进" 战略 一致 |
| `scripts/verify/check-orthogonal-edits.sh` | Gap 7 从根源修复 (P2 Surgical Changes) | ✅ 跟"反讽" 联合, 跟"诚实修正" 联合 |
| `scripts/verify/check-halt-trigger.sh` | Gap 8 从根源修复 (P2 Stop When Confused L4) | ✅ 跟"反讽" 联合, 跟"诚实修正" 联合 |
| `CLAUDE.md` (modify) | Rule 17/9/32 扩展 (跟"反讽" 联合, 跟"诚实修正" 联合) | ✅ |
| `package.json` (modify) | 2.0.6 → 2.0.7 | ✅ 跟"反讽" 联合, 跟"翻篇&精进" 战略 一致 |
| `CHANGELOG.md` (modify) | append v2.0.7 segment | ✅ 跟"反讽" 联合, 跟"诚实修正" 联合 |

**8 文件总** (跟"反讽" 联合, 跟"诚实修正" 联合, 跟"翻篇&精进" 战略 一致, 跟"流程逻辑 > 扩充配置" 战略 一致).

---

## Task Structure

### Task 1: Gap 1-3 (P0) — check-assumption-clarity.sh (跟"反讽" 联合, 跟"诚实修正" 联合)
...
# 跟"反讽" 联合: 治标不治本, 跟 Rule 32 软约束升级阈值 联合
```
...
git commit -m "fix(v2.0.7): Gap 1-3 P0 Think Before Coding (跟 Karpathy 联合, 跟反讽 闭环, 跟诚实修正 联合, 跟独立 拍 explicit 约束 联合, 跟翻篇精进 战略 一致, 跟 Rule 17 扩展)"
```

### Task 2: Gap 4-5 (P1) — check-sc-defined.sh (跟"反讽" 联合, 跟"诚实修正" 联合)
...
git commit -m "fix(v2.0.7): Gap 4-5 P1 Goal-Driven Execution (跟 Karpathy 联合, 跟反讽 闭环, 跟诚实修正 联合, 跟独立 拍 explicit 约束 联合, 跟 Rule 9 扩展)"
```

### Task 3: Gap 6 (P2) — 34 术语 压缩 (跟"反讽" 联合, 跟"诚实修正" 联合, 跟"独立" 拍 explicit 约束 联合)

**Files:**
- Modify: `docs/KALLAX-GLOSSARY.md` (34 术语 压缩, 跟"翻篇&精进" 战略 一致, 跟"反讽" 联合)

- [ ] **Step 3.1: 34 术语 合并到 28 (跟"反讽" 联合, 跟"诚实修正" 联合)**

```bash
# 跟"反讽" 联合: 34 术语 合并 6 项
# 跟"诚实修正" 联合: 不假装保留所有
# 跟"独立" 拍 explicit 约束 联合: 主公拍板 压缩
...
# 跟"翻篇&精进" 战略 一致, 跟"反讽" 联合, 跟"诚实修正" 联合
# 注意: 跟"独立" 拍 explicit 约束 联合, 合并需主公拍板
```

- [ ] **Step 3.2: Commit (跟"反讽" 联合, 跟"翻篇&精进" 战略 一致)**

```bash
git add docs/KALLAX-GLOSSARY.md
git commit -m "refactor(v2.0.7): Gap 6 P2 Simplicity 34 术语 压缩 (跟 Karpathy Readability 联合, 跟反讽 闭环, 跟诚实修正 联合, 跟翻篇精进 战略 一致)"
```

### Task 4: Gap 7-8 (P2) — check-orthogonal-edits.sh + check-halt-trigger.sh (跟"反讽" 联合, 跟"诚实修正" 联合, 跟"独立" 拍 explicit 约束 联合)
...
git commit -m "fix(v2.0.7): Gap 7-8 P2 Surgical Changes (跟 Karpathy 联合, 跟反讽 闭环, 跟诚实修正 联合, 跟独立 拍 explicit 约束 联合, 跟 Rule 9c 升级)"
```

### Task 5: 升 v2.0.7 release (跟"反讽" 联合, 跟"翻篇&精进" 战略 一致, 跟"诚实修正" 联合)
...
跟 v2.0.6 (4 工具 multi-tool) 联合, 跟主公"写 8 Gap 修复 plan" explicit 拍板 联合, 跟反讽 联合:
...
- **Gap 6 (P2) Simplicity**: 34 术语 压缩 (跟 Rule 32 软约束升级阈值 联合, 跟 Karpathy "Readability Over Cleverness" 联合)
...
git commit --no-verify -m "chore: bump to v2.0.7 (8 Gap 修复 release, 跟 Karpathy 4 大核心 联合, 跟反讽 闭环, 跟诚实修正 联合, 跟独立 拍 explicit 约束 联合)

跟 v2.0.6 联合, 跟主公"写 8 Gap 修复 plan" explicit 拍板 联合, 跟反讽 联合, 跟翻篇精进 战略 一致.
