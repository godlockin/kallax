...
## 待 主公 拍板 v3.6.0 整合 (跟"独立" 拍 explicit 约束 联合)

| 整合方案 | 内容 | 跟"独立" 拍板 联合 |
|---------|------|----------------|
| A 合并进 degradation-strategy.md §X | 3 tier degradation 内容 直接 加到 degradation-strategy.md 新章节, 删 nested dir | 待主公 拍 |
| B 合并进 isolation-strategy.md §X | 跟 tier degradation 隔离策略 联合, 删 nested dir | 待主公 拍 |
| C 保留 nested dir + 显式 mark DEPRECATED | 跟 v3.2.0 拍 C "重写 > 删除" 联合, 留 ref history | 待主公 拍 |
...
本 ERRATA 文档 不改 nested dir 内容 (跟"独立" 拍板 联合, 不擅自 删 / 重写 / 整合), 仅 显式 list 待主公 拍板 选项. 跟 V310-B U-002 1:1: 留待主公拍板.
