...
> **理由**: 跟 v3.2.0 拍 C "重写 > 删除" 配合, 0 风险, 跟 v3.6.0 简化哲学 配合 (1 主 + 0 sub-doc sprawl, 但 online-deploy 是 例外)
...
## 2. 跟 v3.6.0 简化 配合 (raw stdout 验证)
...
`_index.md` 1 段 引用 跟 v3.6.0 `_index.md` 配合 模式 (跟 v3.6.0 5 release 累计 简化 1:1).

## 3. 跟 v3.2.0 拍 C 配合 (历史 1:1)

v3.2.0 拍 C "重写 > 删除" 4 DEPRECATED sub-doc 覆盖重写, 跟 v3.7.0 选项 C 配合.
