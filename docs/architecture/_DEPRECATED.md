...
**v3.2.0**: ✅ **主公拍 C 覆盖重写** (commit `08f2393`, 4 files +1453/-857 行, 跟 v3.x 1:1 同步). 不删, 留 reference history. 跟"诚实修正" 联合 ("重写就是重写" 诚实), 跟 v3.1.0 P-005 治根 联合, 跟"独立" 拍 explicit 约束 联合. 跟 v3.3.0 release 联合 闭环 (跟 F1 联合).