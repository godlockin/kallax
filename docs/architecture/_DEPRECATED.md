...
| 子文档 | 替代主文档章节 | 整合时间 | 原因 |
|--------|----------------|----------|------|
| `framework.md` | `docs/ARCHITECTURE.md` §3.1 (顶层架构图) + §9 (3 层降级) | Iter 11 (v2.7.6 → v3.0.0 整合) | v2.7.6 旧版, 配合 v3.0.0 不一致 |
...
决策者拍板 删除前, 需跑 `_index.md` §"DEPRECATED 清理时间表" 中 对照验证 命令.

## 决策者拍 决策 (跟"独立" 拍 explicit 约束,配合, 跟"同类症状" 完整完成)

**v3.1.0**: ✅ 保留 (跟 Iter 12 "不删" 决定 一致), 加清理时间表.
**v3.2.0**: ✅ **决策者拍 C 覆盖重写** (commit `08f2393`, 4 files +1453/-857 行, 配合 v3.x 1:1 同步). 不删, 留 reference history. 跟"诚实修正评估",配合 ("重写就是重写" 诚实), 配合 v3.1.0 P-005 从根源修复,配合, 跟"独立" 拍 explicit 约束,配合. 配合 v3.3.0 release,配合 完整完成 (跟 F1,配合).