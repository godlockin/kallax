...
> 5 release 累计 32 findings 100% 从根源修复 完整完成 | 跟 eket 借鉴 0 增 Rule

## §1 5 levels × 4 roles = 25 cells
- L1 git / L2 stdout / L3 4-expert / L4 independent / L5 boundary
- 跟 eket 借鉴 (5 levels 验证 机制)
...
- 跟 Rule 14 (3 模式) + Rule 18 (KPI 黑名单),配合

## §3 实现在 scripts/permission/decision-matrix.sh (the law)
- --self-test 输出 25/25 cells covered + 5 L4 决策者拍
- --check <role> <level> 输出 mode (自主/推荐/决策者拍)
- 0 文档化 0 narrative 包装

## §4 跟 eket 借鉴 0 增 Rule
- eket 1 主文档 + 0 sub-doc sprawl (跟 KALLAX docs/architecture/_index.md 1:1)
- eket 25 cells 决策 模式 (跟 KALLAX 5 levels × 5 roles 1:1)

## §5 5 release 累计 32 findings 100% 从根源修复 完整完成
- v3.0.0: 6 武器 起点
- v3.1.0: 16 hotfix 从根源修复
- v3.2.0: rtk + caveman 整合
- v3.3.0: 4→5 层 升级
- v3.5.0: 16 findings 从根源修复
