...
## 6. Recent EPICs (v3.32.2 → v3.32.7, 主公 2026-08-02/03/05 拍板)
...
| EPIC-166 | v3.32.7 | heartbeat daemon + quota-aware 调度 + run-history event ledger | `scripts/heartbeat/{daemon,quota,scheduler,run-history}.sh`, `state/run-history.jsonl` |
