...
| EPIC-164 | v3.32.9 | kallax-self-repair 5 步 repair loop + dream-up (运行时自修复) | `.claude/skills/kallax-self-repair/SKILL.md`, `tests/integration/kallax-self-repair.test.sh` |

**0 增 Rule, 0 增 immutable script, 0 改 source code** for all EPICs. Full docs + tests + scripts in each.
