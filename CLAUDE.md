...
## 6. Recent EPICs (v3.32.2 → v3.32.6 + EPIC-172, 主公 2026-08-05 拍板)
...
**0 增 Rule, 0 增 immutable script, 0 改 source code** for all 5 EPICs + EPIC-172. Full docs + tests + scripts in each.
