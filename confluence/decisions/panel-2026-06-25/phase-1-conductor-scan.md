...
| **.md files** | 356 (累计 docs/confluence/jira) | 1 主题 1 文档 留待 治根 |
| **.json files** | 187 (累计 docs/confluence/jira) | 1 主题 1 文档 留待 治根 |
...
## 1.2 文档树 结构 (跟"品味" 联合 跨 release 留待 治根)
...
```
confluence/
├── architecture/                      # 0 files (跟 docs/architecture/ 重复 留待 治根)
...
## 1.3 命名 模式 混用 (跟"品味" 战略 联合 跨 release 留待 治根, 0 强制 拍板)
...
**0 命名 共识** (跟"品味" 战略 联合 跨 release 留待 治根, 跟"独立" 战略 联合 0 ai-auto 拍板).
...
**7 重复 类型** (跟"诚实修正" 战略 联合 0 隐藏, 跨 release 留待 治根).
...
**7 archive 路径 散乱** (跨 release 留待 治根).

## 1.6 顶层 index 缺失 (跟"品味" 战略 联合 跨 release 留待 治根)

| 路径 | README.md | 备注 |
|------|-----------|------|
| `docs/` | ❌ | 跨 release 留待 治根 (跟"品味" 联合 0 跨 session 拍板) |
| `docs/architecture/` | ❌ | 跨 release 留待 治根 |
| `docs/process/` | ❌ | 跨 release 留待 治根 |
| `confluence/` | ❌ | 跨 release 留待 治根 |
| `confluence/decisions/` | ❌ | 跨 release 留待 治根 |
| `confluence/memory/` | ❌ | 跨 release 留待 治根 |
| `confluence/memory/lessons/` | ✅ | 跨 release 留待 1 file (跟"品味" 联合) |
| `jira/` | ❌ | 跨 release 留待 治根 |
| `jira/epics/` | ❌ | 跨 release 留待 治根 |
| `jira/tickets/` | ❌ | 跨 release 留待 治根 |

**9/10 路径 缺 README.md** (跟"品味" 战略 联合 跨 release 留待 治根).
...
| **R3**: 治根 反复 风险 | 0 命名 共识 → 反复 治根 | 跟"独立" 战略 联合 master explicit 拍 1 命名 共识 |
| **R4**: 跨 release debt 风险 | 1 主题 1 文档 留待 → 跨 release 留待 重新 治根 | 跟"翻篇&精进" 战略 联合 0 强制 拍板 |
...
| **R8**: 0 隐藏 debt 风险 | 跟"诚实修正" 战略 联合 0 隐藏 governance gap | 7 重复 类型 跨 release 留待 治根 文档化 |
...
```
docs/
├── README.md                          # NEW (跟"品味" 联合 跨 release 留待 治根)
├── adr/                               # Architecture Decision Records
├── api/                               # API 文档
...
- **P1 (流程 升级)**: 1 命名 共识 + 7 重复 治根 + 9 顶层 README
