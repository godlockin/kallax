...
| 2026-06-07 20:30 | 用户加 Rule 6+7 (EPIC 三件套 + PHASE 完整完成 review) |
...
- **G3**: **跨阶段经验不升级 = 单点案例堆积**
  ...
  - 修复: 写 Rule 6 (EPIC 三件套) + Rule 7 (PHASE 完整完成 review)
...
- 配合 EPIC-016 互补: 016 解决 init 性能, 021 建立 expert 体系
...
- [ ] 准备 Permission Model v1 范围 (决策者已决策, 12-14d)

### 8.2 EPIC-022 候选 scope (从决策者决策)
...
候选升级项 (待 Phase 002 review 时决策者审批):
