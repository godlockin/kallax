...
- [架构概览](../docs/architecture/FRAMEWORK.md) - 系统设计白皮书

### 🎯 模式 (Patterns)
- [并行隔离策略](patterns/isolation-strategy.md) - Worktree + File Scope
- [错误传播模式](patterns/error-propagation.md) - Result 链式处理
- [资源管理模式](patterns/resource-management.md) - TTL + LRU + 连接池
...
### 📝 决策 (Decisions)
- [ADR-001: 选择 Conductor-Performer 命名](../decisions/adr-001-naming.md)
- [ADR-002: 强制 Worktree 隔离](../decisions/adr-002-isolation.md)
- [ADR-003: 禁用 expect/unwrap](../decisions/adr-003-error-handling.md)
...
### 我要开始一个新任务
1. 阅读 [Performer 规则](../../template/docs/PERFORMER-RULES.md)
2. 检查 [File Scope 声明](../jira/schemas/ticket-schema.md#file-scope-规则-kallax-新增)
